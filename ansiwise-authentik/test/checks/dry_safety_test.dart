...
/// dry-safety — no step of [authentikRegistry] can complete a mutation under `--mode dry`.
///
...
Future<void> main() => auditDrySafety(authentikRegistry, answeringOnTrust: const <String>[]);
