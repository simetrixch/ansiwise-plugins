...
void main() {
  ...
  group('counter-probe', () {
    ...
    // point of this probe: a step named for the command it runs is exactly what a substring match
    // would eat, so it is what reports the check having been "simplified" back into one.
