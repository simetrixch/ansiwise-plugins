...
/// tool-purity — this plugin knows helm the tool and never an application of it.
///
/// The helm plugin knows how a chart repository is registered and how a pinned release is converged.
/// What it may never know is any one product built with helm: which repositories exist, which
/// releases are installed, into which namespaces, from which values files — every such name belongs
/// to a program row, never to this package.
///
