...
void main() {
  ...
  group('counter-probe', () {
    ...
    for (final String planted in <String>[
      'the release now runs the new chart, and what the old one had written into the cluster is not '
          'recorded anywhere',
      'the values the release was running with are replaced, and nothing kept the previous ones',
      'the objects the chart created are deleted, and what they held is gone with them',
    ]) {
...
final class _SaysWhatIsLost extends IrreversibleStep {
  ...
  String get irreversibleReason =>
      'the release now runs the new chart, and what the old one had written into the cluster is '
