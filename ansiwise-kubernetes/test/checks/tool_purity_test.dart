...
///
/// The kubernetes plugin knows how kubectl is invoked and what the objects it drives call
/// themselves — kube-system, cert-manager and default-ipv4-ippool are names those tools gave
/// themselves. What it may never know is any one product built on a cluster: its namespaces, its
/// chart names, its issuer names, its config keys — every such name belongs to a program row,
