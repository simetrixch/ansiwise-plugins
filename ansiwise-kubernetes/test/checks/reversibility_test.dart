...
void main() {
  ...
  group('counter-probe', () {
    ...
    for (final String planted in <String>[
      'the address pool a running cluster is using is gone, and what is lost is state nothing wrote '
          'down',
      'the object is deleted, and nothing recorded the fields the API server had filled in',
      'the pods were killed, and what they held in memory since they started is not written anywhere',
    ]) {
...
final class _SaysWhatIsLost extends IrreversibleStep {
  ...
  String get irreversibleReason =>
      'the address pool a running cluster is using is gone, and what is lost is state nothing '
      'wrote down';
