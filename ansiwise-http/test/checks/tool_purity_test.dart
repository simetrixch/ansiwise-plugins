...
/// tool-purity — this plugin knows HTTP as a tool and never an application of it.
///
/// It knows the shapes the protocol defines for itself — a method, an address, a header, a body, a
/// status, a field of a JSON answer. What it may never know is WHICH addresses answer, which
/// fields matter or which product's interface it is pointed at — every such name belongs to a
/// program row or an answer, never to this package.
///
