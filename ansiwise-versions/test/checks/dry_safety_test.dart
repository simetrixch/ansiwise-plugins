...
/// dry-safety — no step of [versionsRegistry] can complete a mutation under `--mode dry`.
///
...
Future<void> main() => auditDrySafety(versionsRegistry, answeringOnTrust: const <String>[]);
