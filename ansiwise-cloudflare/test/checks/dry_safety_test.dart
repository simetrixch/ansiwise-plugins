...
/// dry-safety — no step of [cloudflareRegistry] can complete a mutation under `--mode dry`.
///
...
Future<void> main() => auditDrySafety(cloudflareRegistry, answeringOnTrust: const <String>[]);
