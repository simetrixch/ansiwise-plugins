...
/// MicroK8s snap — and never an application of them. Every name a product decides — a file path, an
/// nft table, a service unit — is a required argument, and the value stands in that product's
/// program row.
library;
