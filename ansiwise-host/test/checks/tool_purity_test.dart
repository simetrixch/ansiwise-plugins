...
///
/// The host plugin knows the tools of a Linux machine — apt, dpkg, snap, sshd, systemd, netplan, nft
/// — and what each of them calls its own things. What it may never know is any one product built on
/// such a machine: its file paths, its unit names, its table names, its domains — every such name
