...
void main() {
  ...
  group('counter-probe', () {
    ...
    // point of this probe: install_packages.dart is a file this very package ships, and it is
    // exactly what a substring match would eat, so it is what reports the check having been
