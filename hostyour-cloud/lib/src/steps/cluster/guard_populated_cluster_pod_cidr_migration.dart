...
/// every one of them.
///
/// **Why a live cluster ever reaches this code.** The branch a machine is installed from receives
/// the trunk's changes by merge before that machine is rebuilt, so a routine re-run of the install
/// on a machine that is serving traffic runs exactly this phase. The supported path for such a
/// machine is a fresh provision, not a swap underneath the workloads.
///
