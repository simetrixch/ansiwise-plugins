...
final class InstallYqCli extends ReversibleStep<bool> {
  ...
  factory InstallYqCli.fromArguments(Arguments arguments) =>
      InstallYqCli(version: arguments.text('version'), path: arguments.text('path'));
  ...
  /// Where the tool goes.
  static const String defaultPath = '/usr/local/bin/yq';

  /// What the tool is called.
  static const String tool = 'yq';
  ...
  String get url => 'https://github.com/mikefarah/yq/releases/download/$version/yq_linux_amd64';
