...
/// reported as being on the modern backend, which is the default of every release this platform
/// supports and the safer of the two to be wrong about — pinning the agent to the older one on a
/// machine that is really on the modern one is the split this measurement exists to prevent.
