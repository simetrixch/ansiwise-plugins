...
///
/// Four releases on top of a standing cluster come from four different repositories, and each of
/// them has to be reachable before the release that needs it is asked for. This is that, once per
/// repository.
///
