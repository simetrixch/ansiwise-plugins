  ...
  group('counter-probe', () {
    ...
    final ExecConfinement planted = ExecConfinement(
      SourceTree.planted(<String, String>{
        ...
        'lib/src/steps/planted.dart': _reach,
        ...
        'tool/ci.dart': _reach,
        'lib/src/steps/only_says_it.dart': _mentionsItInAComment,
      }),
    );
    ...
    test('a line that only names the reach in a comment is not a reach', () {
      expect(
        about(reported, 'lib/src/steps/only_says_it.dart'),
        isEmpty,
        reason:
    ...
    test('a finding names the line the reach sits on', () {
      expect(
        about(reported, 'lib/src/steps/planted.dart').map((Finding hit) => hit.line),
        contains(2),
        reason:
