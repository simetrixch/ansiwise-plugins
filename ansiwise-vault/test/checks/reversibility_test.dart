...
void main() {
  ...
  group('counter-probe', () {
    ...
    for (final String planted in <String>[
      'the quorum is minted once and never again, so a second one would leave the sealed data '
          'unreadable',
      'the entry is overwritten, and what stood under that key before is held nowhere else',
      'the mount is gone, and every secret it carried went with it',
    ]) {
